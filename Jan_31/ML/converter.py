...
def main():
    ...
    for i in range(len(classfication)):
        ...
        ge = " => "
        ln = "\n"
        ww = '%s%s%s%s%s%s%s%s%s%s%d%s%d%s' % (d,w,g,x,g,y,g,z,ge,e,c,g,p,ln) # to combine all for line
        #print(w)
        file_obj.write(ww)

    # Generate entries for classifrication table
    d = "table_add classes_forward class_forward "
    p = 1
    tt = unique(t5)
    ...
    for i in range(5):
        ...
        ge = " => "
        ln = "\n"
        ww = '%s%d%s%s%d%s' %(d,i,ge,e,i,ln) # to combine all for line
        #print(w)
        file_obj.write(ww)
