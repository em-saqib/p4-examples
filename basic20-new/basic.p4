...
control MyIngress(inout headers hdr,
    ...
    apply {
        if (hdr.ipv4.isValid()) {
            ...
            log_msg(" INFO Size : {} ", {hdr.ipv4.len});
...
control MyEgress(inout headers hdr,
    ...
    apply {
          ...
          // Queue depth: standard_metadata.enq_qdepth
          // Queue time: standard_metadata.egress_global_timestamp - standard_metadata.enq_timestamp
