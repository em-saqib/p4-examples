...
def writeactionrule(p4info_helper, switch, a, action, port):
...
def main(p4info_file_path, bmv2_file_path):
    ...
    try:
        ...
        for i in range(len(classfication)):
            ...
            #if ac == 0:
                #writeactionrule(p4info_helper, s1, a, "MyIngress.drop", 0)
            #else:
                #writeactionrule(p4info_helper, s1, a, "MyIngress.ipv4_forward", ac)
                #print("OKK3")
