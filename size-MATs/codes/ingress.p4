        ...
        //feature1_exact.apply();
            if(hdr.ipv4.protocol ==6) {
                ...
                hash(meta.flowID,
                    ...
                    if (meta.packet_counter < 3)
                    {
                        flows_vector.write((bit<32>)(meta.flowID*3+meta.packet_counter), meta.packetSize);
                    ...
                    if (meta.packet_counter == 3){
                        ...
                        flows_vector.read(meta.firstPacketSize, (bit<32>)(meta.flowID*3+1));
                        flows_vector.read(meta.secondPacketSize, (bit<32>)(meta.flowID*3+2));
                        flows_vector.read(meta.thirdPacketSize, (bit<32>)(meta.flowID*3+3));
                        ...
                        classifiedFlows.write((bit<32>)meta.flowID, meta.classID);
                    }

                    // Directly forward packet if the flow is classifed
                    // If counter reaches limit anf flow is classified, add boolean condition
                    if (meta.packet_counter > 3){
                        ...
                        if (meta.classID != 0){
                            ...
                            // Apply class on classiifed flows
