...
def main(pkts):
    ...
    sendpfast(pkts, pps=50000, loop=1, iface=iface)
    print("Finished!")
...
if __name__ == '__main__':
    ...
    try:
        ...
        if not os.path.isfile('./pcap/filtered4.pcap'):
            packets = rdpcap("pcap/filtered4.pcap")
            add_int("./pcap/filtered4.pcap", packets)
