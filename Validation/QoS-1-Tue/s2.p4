...
struct local_metadata_t {
    ...
    bit<16> failedPacket_c1;
    bit<16> failedPacket_c2;
    bit<16> failedPacket_c3;
...
control MyIngress(inout headers hdr,
    ...
    apply {
        if (hdr.ipv4.isValid()) {
            ...
            // Calculate deadline violation
            else{
              if(hdr.int_header.class == 1){
                metadata.failedPacket_c1 = metadata.failedPacket_c1 + 1;
              }
              if(hdr.int_header.class == 2){
                metadata.failedPacket_c2 = metadata.failedPacket_c2 + 1;
              }
              if(hdr.int_header.class == 3){
                metadata.failedPacket_c3 = metadata.failedPacket_c3 + 1;
              }
            }
            log_msg(" INFO Deadline Violation Class-1 : {} Class-2 : {} Class-3 : {} ", {metadata.failedPacket_c1, metadata.failedPacket_c2, metadata.failedPacket_c3});
            }
        }
    }
}
