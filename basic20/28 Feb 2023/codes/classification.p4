...
control classification (
    ...
    register<bit<16>>(10000) packet_counter_reg;
    register<bit<16>>(100) flow_counter_reg;
    register<bit<16>>(10000) classifiedFlows;
...
apply {
          ...
          hash(metadata.flowID,
              ...
              metadata.packetSize = hdr.ipv4.len + 1;  // The header size (40 bytes befire INT and 53 after) included in total length
